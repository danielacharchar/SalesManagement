        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistrationDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2016, 9, 17, 22, 38, 51, 769, DateTimeKind.Local)),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaleCommission", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SaleCommission_Sale_SaleId",
                        column: x => x.SaleId,
                        principalTable: "Sale",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SaleCommission_User_SellerId",
                        column: x => x.SellerId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleCommission_SaleId",
                table: "SaleCommission",
                column: "SaleId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleCommission_SellerId",
                table: "SaleCommission",
                column: "SellerId");
